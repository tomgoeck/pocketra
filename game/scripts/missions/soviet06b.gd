...
func begin_intro() -> void:
	...
	api.reinforce(ussr, ["e6", "e6", "e6", "e6", "e6"], [_loc("McvWaypoint"), _loc("APCWaypoint1")], 10)
	api.reinforce(ussr, ["e4", "e4", "e2", "e2", "e2"], [_loc("McvWaypoint"), _loc("APCWaypoint2")], 10)
...
func send_reinforcements() -> void:
	api.after_delay(ENEMY_ATTACK_DELAY.get(difficulty, 4000), func():
		...
		api.reinforce(greece, types, path, 15, func(u): api.hunt(u))
		send_reinforcements())
