...
static func set_tilesets(names: PackedStringArray) -> void:
	_call("set_tilesets", [names], null)


static func set_web_pages(on: bool) -> void:
	_call("set_web_pages", [on], null)


static func reset_built() -> void:
	_call("reset_built", [], null)
